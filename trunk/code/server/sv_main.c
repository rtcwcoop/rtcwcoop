...
void SVC_Info( netadr_t from ) {
	...
	// if there are 62 bots on a 64 player server
	// and sv_maxcoopclients is set to 4, then the number of available
	// spots is wrong.
	...
	Info_SetValueForKey( infostring, "g_needpass", va( "%d", Cvar_VariableIntegerValue( "g_usePassword" ) ) );
