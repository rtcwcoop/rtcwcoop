...
void SV_GetChallenge(netadr_t from)
{
	...
	if ( sv_onlyVisibleClients->integer ) {
		NET_OutOfBandPrint(NS_SERVER, challenge->adr, "challengeResponse %d %d %d %i",
		challenge->challenge, clientChallenge, com_protocol->integer, sv_onlyVisibleClients->integer);
	} else {
